...
| Befund | Umsetzung | Test (19.09.2026) | Ergebnis |
|---|---|---|---|
| H14 | `on_applet_clicked` entfernt; Menüeintrag „Internet-Speedtest starten“ im Rechtsklick-Menü des Applets; Hinweistext im Schema angepasst | Linksklick, dann Rechtsklick (16:15:48) | **behoben, durch Test belegt:** Linksklick ohne Wirkung, Menüeintrag vorhanden. Folgeentscheidung des Nutzers: Belegung des freien Linksklicks in **AP21** („Aktion bei Linksklick“, Vorgabe „Anzeige ein/aus“) |
