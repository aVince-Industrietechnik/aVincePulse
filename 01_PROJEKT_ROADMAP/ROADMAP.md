...
aVincePulse soll aus zwei zusammengehörigen Komponenten bestehen:
1. aVincePulse Applet
2. aVincePulse Desklet

Beide Komponenten sollen möglichst dieselben Messdaten und Einstellungen verwenden.
...
Ziel:
- Applet und Desklet gehören funktional zusammen
- möglichst einfache gemeinsame Installation
- Prüfung notwendiger Abhängigkeiten
- Sensorerkennung bei Ersteinrichtung
- Benutzer wählt gewünschte Messwerte
- saubere Deinstallation
- keine unnötigen Systemänderungen

Die Anforderungen der offiziellen Cinnamon-Spices-Infrastruktur werden berücksichtigt.
...
- gemeinsame Messdatenbasis
- automatische Sensorerkennung
- Applet/Desklet-Kommunikation
- Einstellungen
- DE/EN
- Abhängigkeiten
- Fehlerbehandlung
